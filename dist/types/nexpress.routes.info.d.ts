...
export interface NEexpressRouterActionInfoResult extends NExpressRouterInfoMethod {
    label: string;
    category: string;
    title: string;
...
export type NExpressRouterInfoCategory = Record<string, NExpressRouterInfoLabel>;
