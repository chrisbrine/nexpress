...
export type routerFunction = (Utils: Record<string, unknown>, Data: Record<string, unknown>, exp: routerFunctionInputs) => void;
export type paramFunction = (req: Request, res: Response, next: NextFunction, id: unknown) => void;
export type NExpressParamsOptions = Record<string, paramFunction>;
export declare enum NExpressVerificationTypes {
    QUERY = "query",
    BODY = "body",
    PARAMS = "params"
}
...
export type verificationFunction = (item: unknown, options?: verificationFunctionOptions) => boolean;
export type NExpressVerificationOptions = {
    [verificationType in NExpressVerificationTypes]: Record<string, verificationFunction | StackProcessor>;
};
